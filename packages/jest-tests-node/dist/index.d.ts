...
declare class CustomHeaderFormDataUploader extends BaseFormDataUploader {
    private endpoint;
    private headers;
...
declare class AuthenticatedFormDataUploader extends CustomHeaderFormDataUploader {
...
export { AssetBuffer, AuthenticatedFormDataUploader, BaseFormDataUploader, CustomHeaderFormDataUploader, FormDataPostHeaders, FormDataRequestOptions, UrlConverter, UrlResolver, handleError };
