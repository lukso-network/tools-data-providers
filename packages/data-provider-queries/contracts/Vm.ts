      ...
      "userdoc": {
        ...
        "methods": {
          ...
          "stopExpectSafeMemory()": {
            "notice": "Stops all safe memory expectation in the current subcontext."
          },
